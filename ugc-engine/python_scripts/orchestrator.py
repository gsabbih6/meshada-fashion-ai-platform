...
AI_MODELS = {
    ...
    "model_3": {
        ...
        "mood": "Authentic, raw, excited, social media vlog energy, relatable, unfiltered",
        "voice_style": "fast-talking, excited, casual",
        "motion_prompt": "UGC vlog video, young woman holding phone in front of her in her messy bedroom, talking excitedly to camera and gesturing with hands, ring light reflection, clean video frame without text overlays",
    },
    "model_4": {
        "name": "Sasha",
...
SCENE_TEMPLATES = {
    ...
    "authentic_ugc": {
        "dress": [
            {"name": "Mirror Selfie Hook", "duration": 2, "motion_prompt": "UGC vertical video, young woman holding phone up high, showing off dress fit in her bedroom mirror, excited facial expression, clean frame without overlays"},
            {"name": "Bed Haul", "duration": 3, "motion_prompt": "UGC haul video, woman sitting on unmade bed, holding up the dress to the camera excitedly, pointing at fabric details, ring light lighting, clean frame"},
            {"name": "Full Spin", "duration": 3, "motion_prompt": "UGC try-on video, woman steps back in her bedroom to show full dress, does a quick casual spin, smiling and talking to camera, messy room background, clean frame"},
            {"name": "Close Up Detail", "duration": 2, "motion_prompt": "UGC close up video, woman showing the neckline of her dress, talking fast to the camera, messy room background, clean frame"},
            {"name": "Package Open", "duration": 3, "motion_prompt": "UGC unboxing video, woman sitting on the floor pulling a dress out of a package, holding it up and gasping excitedly, clean frame"},
            {"name": "Dance Fit", "duration": 3, "motion_prompt": "UGC try-on, woman doing a quick trendy dance in her bedroom wearing a new dress, laughing, casual relatable vibe, clean frame"},
            {"name": "Sitting Pose", "duration": 3, "motion_prompt": "UGC casual video, woman sitting on a bedroom chair wearing a new dress, talking animatedly with hand gestures to the camera, relatable energy, clean frame"},
            {"name": "Walking Hook", "duration": 2, "motion_prompt": "UGC vlog, woman walking towards camera, showing off how the dress flows when walking, happy expression, clean frame"},
            {"name": "Pocket Check", "duration": 2, "motion_prompt": "UGC video, woman excitedly showing that her dress has pockets, putting her hands in the pockets and smiling at the camera, clean frame"},
            {"name": "Coffee Run", "duration": 3, "motion_prompt": "UGC lifestyle vlog, woman holding a coffee cup, taking a sip while showing off her dress fit in natural sunlight from her window, clean frame"},
            {"name": "Back Detail", "duration": 3, "motion_prompt": "UGC mirror video, woman turning to show the back cut-out of her dress, looking over her shoulder into the mirror, clean frame"},
            {"name": "Fabric Flow", "duration": 2, "motion_prompt": "Woman holding the hem of her dress and swishing it back and forth to show the fabric flow, smiling at the camera, messy bedroom, clean frame"},
            {"name": "Hanger Show", "duration": 2, "motion_prompt": "UGC unboxing, woman holding the dress on a hanger, pointing at the pattern, talking excitedly to the camera, ring light, clean frame"},
            {"name": "Try-On Jump", "duration": 2, "motion_prompt": "UGC transition, woman holding dress, jumps and suddenly she is wearing it, laughing and showing off the fit, clean frame"},
            {"name": "Adjusting Fit", "duration": 3, "motion_prompt": "UGC video, woman standing in front of mirror, adjusting the straps of her dress, talking to the camera casually, clean frame"},
            {"name": "Shoe Pairing", "duration": 3, "motion_prompt": "Woman sitting on bed, holding up a pair of shoes next to her new dress, asking the camera for styling advice, relatable haul video, clean frame"},
            {"name": "Candid Laugh", "duration": 2, "motion_prompt": "Close up, woman laughing candidly while talking about her dress, hand covering her mouth slightly, genuine relatable expression, clean frame"},
            {"name": "Window Light", "duration": 3, "motion_prompt": "Woman standing by her bedroom window, natural light hitting the dress, turning slightly to show how it looks in the sun, clean frame"},
            {"name": "Quick Zoom", "duration": 2, "motion_prompt": "UGC style, quick zoom into the woman's face as she hypes up the dress, chaotic fun energy, messy bedroom, clean frame"},
            {"name": "Outro Wave", "duration": 3, "motion_prompt": "UGC outro, woman waves goodbye to the camera, stepping back in her dress, blowing a kiss, clean frame with no text overlays"}
        ],
        "outerwear": [
            {"name": "Mirror Selfie", "duration": 2, "motion_prompt": "UGC mirror video, woman showing off her new jacket, zipping it up excitedly, messy bedroom background, clean frame without overlays"},
            {"name": "Bed Haul", "duration": 3, "motion_prompt": "UGC haul video, woman holding up jacket to camera in her room, pointing at the pockets and texture, talking animatedly, ring light reflections, clean frame"},
            {"name": "Shoulder Drape", "duration": 3, "motion_prompt": "UGC try-on, woman puts on jacket over her shoulders in her bedroom, poses casually, smiles, relatable everyday vibe, clean frame"},
            {"name": "Close Up", "duration": 2, "motion_prompt": "UGC front-facing video, woman adjusting the collar of her jacket, smiling broadly at the camera, ring light in eyes, clean frame"},
            {"name": "Package Open", "duration": 3, "motion_prompt": "UGC unboxing video, woman pulling a jacket from a shipping bag, throwing the bag aside and holding the jacket up with excitement, clean frame"},
            {"name": "Full Spin", "duration": 3, "motion_prompt": "UGC try-on, woman steps back to show full jacket fit, turns around to show the back, looking over her shoulder at the camera, messy bedroom, clean frame"},
            {"name": "Zipper Check", "duration": 2, "motion_prompt": "UGC close up, woman demonstrating how smooth the jacket zipper is, zipping it up and down while talking to camera, clean frame"},
            {"name": "Hood Pull", "duration": 3, "motion_prompt": "UGC vlog, woman pulling the jacket hood over her head, doing a cute pose, laughing at the camera, cozy bedroom setting, clean frame"},
            {"name": "Pocket Deep", "duration": 2, "motion_prompt": "Woman enthusiastically shoving her hands deep into the jacket pockets to show how big they are, excited facial expression, clean frame"},
            {"name": "Layering Show", "duration": 3, "motion_prompt": "UGC try-on, woman unzipping jacket to show how she layered it over a hoodie, casual streetwear styling video, clean frame"},
            {"name": "Walking Hook", "duration": 2, "motion_prompt": "Woman walking towards camera wearing an oversized jacket, confident stride, messy room background, clean frame"},
            {"name": "Throw On", "duration": 2, "motion_prompt": "UGC transition, woman throwing the jacket into the air and suddenly she is wearing it, striking a pose, fun energy, clean frame"},
            {"name": "Lining Detail", "duration": 2, "motion_prompt": "UGC video, woman opening the jacket to show the inner lining to the camera, pointing at the details, talking fast, clean frame"},
            {"name": "Cuff Check", "duration": 2, "motion_prompt": "Close up, woman showing the sleeve cuffs of her new jacket, turning her wrist, casual review video, clean frame"},
            {"name": "Back Logo", "duration": 3, "motion_prompt": "Woman turning her back to the camera to show off the design on the back of the jacket, looking over her shoulder, clean frame"},
            {"name": "Cozy Hug", "duration": 3, "motion_prompt": "UGC lifestyle, woman wrapping her arms around herself to show how warm and cozy the jacket is, smiling happily, clean frame"},
            {"name": "Hanger Show", "duration": 2, "motion_prompt": "Woman holding the jacket on a hanger, pointing at it with her other hand, explaining why she bought it, clean frame"},
            {"name": "Window Light", "duration": 3, "motion_prompt": "Woman standing by her window showing how the jacket material looks in natural sunlight, authentic vlog style, clean frame"},
            {"name": "Quick Zoom", "duration": 2, "motion_prompt": "UGC style, quick zoom on woman's face as she gasps about the jacket quality, funny relatable energy, clean frame"},
            {"name": "Outro Wave", "duration": 3, "motion_prompt": "UGC outro, woman fully zipped in her jacket, waves goodbye to the camera with a big smile, clean frame with no text overlays"}
        ],
        "pants": [
            {"name": "Mirror Selfie", "duration": 2, "motion_prompt": "UGC mirror video, woman angling phone down to show off pants fit, turning hips side to side, casual bedroom setting, clean frame without overlays"},
            {"name": "Bed Haul", "duration": 3, "motion_prompt": "UGC haul video, woman sitting cross-legged on bed, holding pants up to camera, stretching the waistband to show elasticity, excited expression, clean frame"},
            {"name": "Full Fit", "duration": 3, "motion_prompt": "UGC try-on video, woman stepping back in room to show full pants fit, hands in pockets, casual pose, talking to camera, relatable energy, clean frame"},
            {"name": "Close Up Waist", "duration": 2, "motion_prompt": "UGC close up, woman pointing to the high waist of her pants, talking to the camera to explain the fit, clean frame"},
            {"name": "Package Open", "duration": 3, "motion_prompt": "UGC unboxing, woman opening a package on her bed, pulling out pants and holding them up against her legs, smiling widely, clean frame"},
            {"name": "Dance Fit", "duration": 3, "motion_prompt": "UGC try-on, woman doing a quick hip-sway trend to show off pants fit, laughing at the camera, relatable and casual, clean frame"},
            {"name": "Squat Test", "duration": 3, "motion_prompt": "UGC review, woman doing a quick squat to show that the pants are stretchy and comfortable, giving a thumbs up to the camera, clean frame"},
            {"name": "Walking Back", "duration": 3, "motion_prompt": "UGC try-on, woman walking away from the camera to show the back fit of the jeans, then turning around and smiling, clean frame"},
            {"name": "Shoe Styling", "duration": 3, "motion_prompt": "Woman pointing the camera down at her feet to show how the pants drape perfectly over her sneakers, street style vlog, clean frame"},
            {"name": "Pocket Check", "duration": 2, "motion_prompt": "Woman putting both hands in the front pockets of her pants, rocking back and forth on her heels, casual talking to camera, clean frame"},
            {"name": "Waist Stretch", "duration": 2, "motion_prompt": "Close up, woman pulling the waistband away from her body to show the stretch, excited facial expression, messy room, clean frame"},
            {"name": "Sitting Check", "duration": 3, "motion_prompt": "UGC video, woman sitting down on her bed to show that the pants are still comfortable when seated, relatable review, clean frame"},
            {"name": "Hanger Show", "duration": 2, "motion_prompt": "Woman holding the pants up on a hanger, pointing at the wash and material, talking fast to the camera, clean frame"},
            {"name": "Jump Transition", "duration": 2, "motion_prompt": "UGC transition, woman throws pants on the floor, jumps, and is suddenly wearing them, striking a cool pose, clean frame"},
            {"name": "Ankle Detail", "duration": 2, "motion_prompt": "Woman pointing the phone camera at the hem of her pants to show the crop/flare detail, clean frame"},
            {"name": "Side Profile", "duration": 3, "motion_prompt": "UGC mirror, woman standing sideways to show the side profile of the pants fit, holding phone steady, clean frame"},
            {"name": "Candid Laugh", "duration": 2, "motion_prompt": "Close up, woman laughing while explaining a funny story about buying the pants, genuine relatable expression, clean frame"},
            {"name": "Material Rub", "duration": 2, "motion_prompt": "Woman rubbing the fabric of the pants to show the texture to the camera, explaining how soft they are, clean frame"},
            {"name": "Quick Zoom", "duration": 2, "motion_prompt": "UGC style, quick zoom into woman's face as she hypes up how good the pants make her look, fun energy, clean frame"},
            {"name": "Outro Wave", "duration": 3, "motion_prompt": "UGC outro, woman doing a casual salute or peace sign to the camera, full pants fit visible, clean frame with no text overlays"}
        ],
        "tops": [
            {"name": "Mirror Selfie", "duration": 2, "motion_prompt": "UGC front-facing video, woman talking excitedly to camera, holding up a cute top, pointing at the neckline, messy bedroom, ring light, clean frame without overlays"},
            {"name": "Bed Haul", "duration": 3, "motion_prompt": "UGC unboxing video, woman sitting on bed, pulling top out of package, holding it against her chest, huge smile, clean frame"},
            {"name": "Full Fit", "duration": 3, "motion_prompt": "UGC try-on, woman standing in bedroom, adjusting the fit of her new top, looking into the phone camera like a mirror, casual everyday vibe, clean frame"},
            {"name": "Close Up", "duration": 2, "motion_prompt": "UGC close up, woman tugging on the sleeve of her top to show the material, talking fast, clean frame"},
            {"name": "Package Open", "duration": 3, "motion_prompt": "UGC unboxing, woman sitting on floor tearing open a package, pulling out a top and showing it to the camera excitedly, clean frame"},
            {"name": "Dance Fit", "duration": 3, "motion_prompt": "UGC try-on, woman dancing casually in her bedroom to show off a new top, happy and energetic, clean frame"},
            {"name": "Neckline Check", "duration": 2, "motion_prompt": "Woman adjusting the neckline of the top, looking at the camera as if it's a mirror, checking her outfit, clean frame"},
            {"name": "Sleeve Roll", "duration": 3, "motion_prompt": "UGC video, woman rolling up the sleeves of her top, talking casually to the camera about styling it, clean frame"},
            {"name": "Tuck In", "duration": 3, "motion_prompt": "UGC try-on, woman demonstrating how to do a french tuck with the new top into her jeans, smiling at the result, clean frame"},
            {"name": "Back Detail", "duration": 3, "motion_prompt": "UGC mirror, woman turning to show the back of the top, looking over her shoulder, clean frame"},
            {"name": "Sitting Pose", "duration": 3, "motion_prompt": "Woman sitting on her unmade bed, wearing the new top, talking animatedly to the camera with hand gestures, clean frame"},
            {"name": "Coffee Run", "duration": 3, "motion_prompt": "UGC lifestyle vlog, woman holding a coffee cup, taking a sip while showing off her top in natural sunlight from her window, clean frame"},
            {"name": "Hanger Show", "duration": 2, "motion_prompt": "Woman holding the top on a hanger, pointing at the print/graphic, talking excitedly to the camera, clean frame"},
            {"name": "Try-On Jump", "duration": 2, "motion_prompt": "UGC transition, woman holding top, covers the camera lens with it, uncovers it and she is wearing it, smiling, clean frame"},
            {"name": "Fabric Stretch", "duration": 2, "motion_prompt": "Close up, woman pulling the fabric of the top to show how stretchy and soft it is, messy bedroom, clean frame"},
            {"name": "Candid Laugh", "duration": 2, "motion_prompt": "Close up, woman laughing candidly while talking about her top, genuine relatable expression, ring light in eyes, clean frame"},
            {"name": "Window Light", "duration": 3, "motion_prompt": "Woman standing by her bedroom window, natural light hitting the top, turning slightly to show the color in the sun, clean frame"},
            {"name": "Styling Ideas", "duration": 3, "motion_prompt": "Woman holding up a jacket or accessory next to the top, asking the camera for styling opinions, interactive vlog style, clean frame"},
            {"name": "Quick Zoom", "duration": 2, "motion_prompt": "UGC style, quick zoom on woman's face as she hypes up the top, funny relatable Gen-Z energy, clean frame"},
            {"name": "Outro Wave", "duration": 3, "motion_prompt": "UGC outro, woman blows a kiss to the camera and waves goodbye, wearing the top, clean frame with no text overlays"}
        ]
    },    "curvy-chic": {
        "dress": [
            ...
            if cached_storyboard and len(cached_storyboard) == len(scenes):
                ...
                for idx, sc in enumerate(scenes):
                    ...
                    keyframe_prompt = (
                        ...
                        f"Do not include any text overlays, captions, usernames, icons, or social media buttons. Ensure a clean visual frame."
                    )
